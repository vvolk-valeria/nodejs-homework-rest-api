Создай ветку `hw03-mongodb` из ветки `master`. Продолжи создание REST API для работы с коллекцией контактов.
...
![Иллюстрация](https://textbook.edu.goit.global/lms-nodejs-homework/v1/img/03/atlas-cluster.jpg)
...
Через Compass создай базу данных `db-contacts` и в ней коллекцию `contacts`. Возьми [ссылка на json](https://downgit.github.io/#/home?url=https://github.com/goitacademy/nodejs-homework/blob/master/homework-03/contacts.json) и при помощи Compass наполни коллекцию `contacts` (сделай импорт) его содержимым.

![Иллюстрация](https://textbook.edu.goit.global/lms-nodejs-homework/v1/img/03/json-data.png)

Если вы все сделали правильно, данные должны появиться в вашей базе в коллекции `contacts`

![Иллюстрация](https://textbook.edu.goit.global/lms-nodejs-homework/v1/img/03/mongo-data.png)
